  ...
  return (
    <div className="mb-16 bg-white dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-800 rounded-3xl p-6 shadow-sm">
      ...
      <div className="flex justify-between items-end mt-8 mb-4">
        <h3 className="text-xl font-bold">AI Agents & Integrations</h3>
        <a 
          href={client.googleRefreshToken ? "#" : `/api/auth/google?clientId=${client.id}`}
          className={`px-4 py-2 rounded-lg text-sm font-bold flex items-center gap-2 transition-colors ${
            client.googleRefreshToken 
              ? "bg-green-100 text-green-700 cursor-default" 
              : "bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 hover:bg-zinc-50 dark:hover:bg-zinc-800 shadow-sm"
          }`}
        >
          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="4" width="18" height="18" rx="2" ry="2"></rect><line x1="16" y1="2" x2="16" y2="6"></line><line x1="8" y1="2" x2="8" y2="6"></line><line x1="3" y1="10" x2="21" y2="10"></line></svg>
          {client.googleRefreshToken ? "Google Calendar Connected" : "Connect Google Calendar"}
        </a>
      </div>
